...
// Helpful when working with replicated and coordinated cluster
// To know what nodes have the oldest
// and what nodes are falling behind and need to replicate
...
// Remove old segments whose data we have processed and don't need anymore
